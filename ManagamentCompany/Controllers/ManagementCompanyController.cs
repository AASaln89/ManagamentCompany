    ...
    public class ManagementCompanyController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var viewModel = new IndexViewModel
            {
                ...
                WorkInProgressTasks = dbWorkTasks
        ...
        public IActionResult Profile()
        {
            ...
            var model = new ProfileViewModel
            {
                ...
                CurrentUserTasks = userTasks.Select(userTask => new TaskViewModel
                {
                    Name = userTask.Name,
        ...
        public IActionResult AddTask(TaskViewModel model)
        {
            ...
            return RedirectToAction("Profile", new { task.Author.Id });
        }
    }
}
